...
let dao = (function(){
    ...
    return function(options){
        ...
        if (sdo) {
            dao.sdo = sdo; // schema dot org
            dao.dataBinder = sdo;
            dao.dataBind = function (selector, data) {
        ...
        dao.getItem = dao.sdo.getItem;
        dao.getItems = dao.sdo.getItems;
